package suzi.com.suzi_game.view;
...
public class PullToloadMore extends ViewGroup{
    public static String TAG = PullToloadMore.class.getName();
    ...
    public PullToloadMore(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.e(TAG, "onTouchEvent11: "+lastY+"--"+y );
